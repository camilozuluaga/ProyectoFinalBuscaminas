...
public class Interfaz extends javax.swing.JFrame implements ActionListener {
     ...
     */
    public Interfaz(ArrayList<Usuarios2> lista) {
        initComponents();
        txtUsuario.setText(lista.get(0).getNombreUsuarioNuevo());
        setLocationRelativeTo(this);
        btnEmpezar.setIcon(new ImageIcon(getClass().getResource("/imagenes/feliz.png")));
        this.paintAll(this.getGraphics());//este metodo lo que hace es pintar toda la interfaz grafica
        //y se va a necesitar para que cuando se dibujen los botones se refleja,
    }
    boolean issuspended = false;//para saber si el hilo esta suspendido o pausado
    ...
    private void initComponents() {
        ...
        barNo = new javax.swing.JMenu();
        barSonido = new javax.swing.JRadioButtonMenuItem();
        ...
        txtPuntaje.setBounds(560, 60, 80, 30);
        jLayeredPane1.add(txtPuntaje, javax.swing.JLayeredPane.DEFAULT_LAYER);
        ...
        txtNivel.setText("1");
        txtNivel.setBounds(100, 70, 50, 40);
        jLayeredPane1.add(txtNivel, javax.swing.JLayeredPane.DEFAULT_LAYER);

        jLabel6.setText("Nivel");
        jLabel6.setBounds(30, 70, 40, 40);
        jLayeredPane1.add(jLabel6, javax.swing.JLayeredPane.DEFAULT_LAYER);
        txtUsuario.setBounds(470, 94, 200, 20);
        ...
        jButton1.setBounds(170, 60, 90, 40);
        ...
        barNo.setText("Sonido");

        barSonido.setSelected(true);
        barSonido.setText("SI/NO");
        barSonido.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                barSonidoActionPerformed(evt);
            }
        });
        barNo.add(barSonido);
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        ...
        try {
            File archivo = new File(this.getClass().getResource("/Imagenes/mi_archivo.chm").toURI());
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        JOptionPane.showMessageDialog(rootPane, "Jose Behar Soto , Juan Camilo Zuluaga, Brayhan Andres Jaramillo");
    ...
    private void barSonidoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_barSonidoActionPerformed
        silencio();
    }//GEN-LAST:event_barSonidoActionPerformed
    ...
    private javax.swing.JMenu barNo;
    private javax.swing.JRadioButtonMenuItem barSonido;
    ...
    public void actionPerformed(ActionEvent evento) {
        ...
        if (boton1.estaMinado()) {
            ...
            if (numeroCuadros - contadorMinas == contador) {
                ...
                txtNivel.setText(String.valueOf(nivel + 1));
                int minas = Integer.parseInt(txtBombas.getText());
                txtBombas.setText(String.valueOf(minas + 1));
                int filas = Integer.parseInt(txtFilas.getText());
                txtFilas.setText(String.valueOf(filas + 1));
                int columnas = Integer.parseInt(txtColumnas.getText());
                txtColumnas.setText(String.valueOf(columnas + 1));
                int puntaje = Integer.parseInt(txtPuntaje.getText());

                txtPuntaje.setText(String.valueOf(puntaje + 10 + contador));

                if (txtNivel.getText().equals("2")) {
                    hilo.suspend();
                    conectar cc = new conectar();
                    Connection cn = cc.conexion();
                    String tiempo = lblTiempo.getText();
                    String puntos = txtPuntaje.getText();
                    String usuario = txtUsuario.getText();
                    int nivel2 = Integer.parseInt(txtNivel.getText());
                    nivel2 = nivel2 - 1;
                    String level = String.valueOf(nivel2);
                    String mysql = "UPDATE registro SET puntaje = '" + puntos + "', tiempo = '" + tiempo + "', nivel = '" + level + "' WHERE nombreUsuario = '" + usuario + "'";
                    try {
