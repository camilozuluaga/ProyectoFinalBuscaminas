...
public class InterfazBienvenida extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jcMousePanel1.setIconLogo(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/buscaminas2.png"))); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        InterfazIniciarSecion a = new InterfazIniciarSecion();
        a.setVisible(true);
        setVisible(true);
        this.dispose();
